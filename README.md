...
- All news articles are presented as compact cards, arranged in a grid.
...
- A reponsive web page that changes its layout based on window size.
...
6. Once both servers are running, open your browser and visit the URL shown in the terminal (http://localhost:8080 by default).
